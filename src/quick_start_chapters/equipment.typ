...
Finally, small Items with 0 #term[Bulk] are called #term("Trinkets", is_definition: true), and don't go in a character's normal Inventory.
...
#figure(
  align(center)[#table(
    ...
    table.hline(),
    [Armor (worn/not worn)], [1+/2+], [Each tier above Light adds +1 #term[Bulk]],
    [Weapon], [1], [],
    [Heavy Weapon], [2], [],
