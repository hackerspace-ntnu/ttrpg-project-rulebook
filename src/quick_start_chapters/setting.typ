...
= Setting
<setting>
A group of scientists discovered an alternate energy source, connecting this world to another through #term("Mana Gates", is_definition: true).
Though incompatible with existing technology due to its disruption of magnetic fields, the near infinite energy source propelled the people of #term[Makkeo] into a new techological revolution.
That is, until the #term[Mana Gates] brought something else with them.

The first #term("Titan", key: "Titans", is_definition: true) emerged decades after #term[Mana Gates] had been widely adopted, but within a year a dozen more do, each bringing a city or more down with them.
...
However, #term("Sanctuary", glossary_type: glossary_types.location)’s research on mana ultimately lead to its downfall, as the dense mana of the growing metropolis attracted both #term[Abberants] and #term[Titanspawn] alike.
...
\
#term("[Titanslayer Religion]", is_definition: true, glossary_type: glossary_types.faction) are at odds with #term("The Children of Og", glossary_type: glossary_types.faction) in the search of #term("The Titanslayer"), a prophesized individual who will liberate the world from the looming threat of #term[Titans].

Though one of the most important vestiges of #term("Sanctuary", glossary_type: glossary_types.location) are the #term("Hunters", is_definition: true, glossary_type: glossary_types.faction).
