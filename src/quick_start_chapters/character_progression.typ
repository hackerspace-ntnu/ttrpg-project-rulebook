...
#term("Corrupted Focus", is_definition: true) works the same as #term[Saturated Focus], but cannot be cleared of its corruption, and cannot be marked as #term("Saturated", key: "Saturated Focus").
...
- Spending #term("Scrap", key: "Scrap") to learn an #term("Tiered Ability", key: "Tiered Abilities") from an NPC or institution that offers it.
...
=== Tiered Abilities
#term("Tiered Abilities", is_definition: true) are #term[Abilities] that you can learn from NPCs or institutions in exchange for #term[Scrap].
...
#term[Tiered Abilities] come in packets of 3 abilities, with each ability in a packet being centered around the same theme or playstyle.
